...
> Status 2026-09-17: Phases 1–7 implemented and smoke-tested locally. Outstanding: create the Supabase project
> and GitHub repo (user actions), deploy the dashboard, install on the Scantech and test the real printer.
> See README.md and docs/go-live-checklist.md.
